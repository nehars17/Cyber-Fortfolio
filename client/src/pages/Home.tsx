          ...
          >
            <div className="relative group">
              ...
              <div className="relative bg-card border border-border rounded-2xl p-8 overflow-hidden">
                ...
                <code className="text-sm font-mono text-muted-foreground block">
                  ...
                  &nbsp;&nbsp;education: [
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-accent">"Nanyang Polytechnic (Forensics)"</span>,
                  <br />
                  &nbsp;&nbsp;&nbsp;&nbsp;<span className="text-accent">"SMU (CS)"</span>
                  <br />
                  &nbsp;&nbsp;],
                  <br />
            ...
            <div>
              ...
              <div className="space-y-4 text-muted-foreground leading-relaxed">
                <p>
                  My journey began in the intricate world of digital forensics at Nanyang Polytechnic, 
                  where I learned to uncover digital footprints and understand the anatomy of cyber incidents.
                </p>
                <p>
                  Furthering my education in Computer Science at SMU, I expanded my repertoire into 
        ...
        <div className="container px-4">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Tools and technologies I use to secure and build the digital world.
            </p>
          </motion.div>
